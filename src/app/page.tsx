export default function Home() {
    return (
        <section className="h-screen flex flex-col justify-center items-center gap-10 px-4">
            ...
            <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold text-2xl sm:text-3xl md:text-4xl px-4 py-2 sm:px-6 sm:py-3 rounded-md cursor-pointer">
                START
            </button>
        </section>
    );
